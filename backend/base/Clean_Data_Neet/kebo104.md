...
Showing germinal layers: (a) Diploblastic (b) Triploblastic
...
# Table of Symmetry and Body Cavity

Table Name: Levels of Symmetry and Body Cavity

|Organisation|Symmetry|Body Cavity|Phylum|
|---|---|---|---|
|Cellular level|Asymmetrical|Acoelomate|Porifera|
|Tissue/Organ|Radial|Acoelomate|Cnidaria|
|Organ system|Bilateral|Pseudocoelomate|Aschelminthes|
|With true coelom|Bilateral|Coelomate|Chordata|

# Images

Image Description: Figure 4.4 illustrates the broad classification of Kingdom Animalia based on common fundamental features.

Image Description: Figure 4.5 shows examples of Porifera: (a) Sycon, (b) Euspongia, (c) Spongilla.
# Chapter Name: ANIMAL KINGDOM
...
They are usually dioecious and oviparous with indirect development. Examples: Pila (Apple snail), Pinctada (Pearl oyster), Sepia (Cuttlefish), Loligo (Squid), Octopus (Devil fish), Aplysia (Sea-hare), Dentalium (Tusk shell) and Chaetopleura (Chiton).
...
Nerve cord, Notochord, Post-anal part, Gill slits

Figure 4.16 Chordata characteristics: hollow nerve cord and paired pharyngeal gill slits (Figure 4.16). These are bilaterally symmetrical, triploblastic, coelomate with organ-system level of organisation. They possess a post anal tail and a closed circulatory system.
...
**Image Description**: Figure 4.22 shows various reptiles including (a) Chameleon, (b) Crocodilus, (c) Chelone, and (d) Naja.
...
Image Description: Figure 4.23 shows various birds including Neophron, Struthio, Psittacula, and Pavo.

Figure 4.24 depicts several mammals including Ornithorhynchus, Macropus, Pteropus, and Balaenoptera.
# Animal Kingdom
...
|---|---|---|---|---|---|---|---|---|---|
|Porifera|Cellular|Various|Absent|Absent|Absent|Absent|Body with pores and canals in walls.| | |
|Coelenterata (Cnidaria)|Tissue|Radial|Absent|Absent|Incomplete|Absent|Cnidoblasts present.| | |
|Ctenophora|Tissue|Radial|Absent|Absent|Incomplete|Absent|Comb plates for locomotion.| | |
|Platyhelminthes|Organ-system|Bilateral|Absent|Absent|Flat body, suckers.| | | | |
|Aschelminthes|Organ-system|Bilateral|Pseudocoelomate|Absent|Absent|Absent|Often worm-shaped, elongated.| | |
|Annelida|Organ-system|Bilateral|Coelomate|Present|Complete|Absent|Body segmentation like rings.| | |
|Arthropoda|Organ-system|Bilateral|Coelomate|Present|Complete|Present|Exoskeleton of cuticle, jointed appendages.| | |
|Mollusca|Organ-system|Bilateral|Coelomate|Absent|Complete|Present|External skeleton of shell usually present.| | |
|Echinodermata|Organ-system|Radial|Coelomate|Absent|Complete|Present|Water vascular system, radial symmetry.| | |
|Hemichordata|Organ-system|Bilateral|Coelomate|Present|Complete|Present|Worm-like with proboscis, collar and trunk.| | |
|Chordata|Organ-system|Bilateral|Coelomate|Present|Complete|Present|Notochord, dorsal hollow nerve cord, gill slits with limbs or fins.| | |
